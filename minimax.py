...
def connect_four_mm(contents, turn, max_depth):
    ...
    col_next_move = minimax(board, turn, max_depth)[0]
...
def minimax(board, turn, depth):
    ...
    if turn == PLAYER_RED:
        ...
        for col in possible_moves:
            ...
            value = minimax(new_board, PLAYER_YEL, depth - 1)[1] 
            if value > max_val:
                max_val = value
                col_best_node = col 
    ...
    # yellow
        ...
        for col in possible_moves:
            new_board = place_token(board, col, turn)
            value = minimax(new_board, PLAYER_RED, depth - 1)[1] 
            if value < min_val:
                min_val = value
                col_best_node = col
...
if __name__ == '__main__':
    observed = connect_four_mm(".......,.......,.......,.......,.......,.......", "red", 1)
    print(observed)